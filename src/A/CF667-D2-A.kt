...
fun main() {
    val (diameter, height, drinkSpeed, growth) = readlnInts()
    val radius = diameter / 2.0
    val growthVolume = radius * radius * growth * PI
    if (drinkSpeed <= growthVolume) return print("NO")
    val deltaVolume = drinkSpeed - growthVolume
    val initialVolume = PI * radius * radius * height
    print("YES\n%.5f".format(initialVolume / deltaVolume))
}
